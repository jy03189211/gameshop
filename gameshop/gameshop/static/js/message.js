/*
 * NOTE: This messaging service must be loaded before the game loader script
 * (game-loader.js) to prevent the case where the iframe content is ready
 * before the parent document. The game loader creates the game iframe only
 * after the parent document is ready to prevent issues with the unknown timing
 * of the async load events.
 */
